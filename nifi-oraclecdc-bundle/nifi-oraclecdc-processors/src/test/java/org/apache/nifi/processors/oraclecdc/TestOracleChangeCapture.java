...
public class TestOracleChangeCapture {
    ...
    public void setup() throws InitializationException {
        ...
        // StandardOracleClassLoaderService clService = new
        // StandardOracleClassLoaderService();
        ...
        // testRunner.setProperty(service, StandardOracleCDCService.DB_HOST,
        // "localhost");
        // testRunner.setProperty(service, StandardOracleCDCService.DB_PORT,
        // "32782");
        // testRunner.setProperty(service, StandardOracleCDCService.DB_USER,
        // "xstrmadmin");
        // testRunner.setProperty(service, StandardOracleCDCService.DB_PASS,
        // "welcome1");
        // testRunner.setProperty(service, StandardOracleCDCService.DB_SID,
        // "orcl");
        // testRunner.setProperty(clService,
        // StandardOracleClassLoaderService.DB_DRIVER_LOCATION,
        // "/tmp/oracle/ojdbc8.jar," + "/tmp/oracle/xstreams.jar");
        // testRunner.enableControllerService(clService);
        // testRunner.setProperty(service,
        // StandardOracleCDCService.DB_CLASS_LOADER, "clService");
        // testRunner.enableControllerService(service);
        // testRunner.setProperty(OracleChangeCapture.CDC_SERVICE,
        // "cdcservice");
